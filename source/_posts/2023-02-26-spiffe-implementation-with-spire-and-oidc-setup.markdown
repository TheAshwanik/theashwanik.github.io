---
layout: post
title: "SPIFFE Implementation with SPIRE And OIDC Setup"
description: "This article will look at quickstart installation of SPIRE"
date: 2023-02-26 18:32:22 +0000
comments: true
tags: [spire, spiffe, oidc, workload identity]
categories: [ Security, Authentication, zerotrust, zta, SPIFFE, SPIRE ]
---
...
<!-- more -->
In this blog, I'll not explore the concepts behind SPIFFE and SPIRE and their benefits for businesses. I'll also not discuss how these frameworks work together to provide a comprehensive security solution. 
Please Read more about SPIFFE and SPIRE seperately.
This article is a note to myself how to quickstart a demo for SPIRE and implementation of SPIFFE.
...
Change service type to LoadBalancer instead of NodePort in the server-service.yaml
Add NodeAttestor join_token in server-configmap.yaml
...
Read this: https://deploy-preview-272--spiffe.netlify.app/docs/latest/try/getting-started-linux-macos-x/#downloading-spire-for-linux
```
...
* https://deploy-preview-272--spiffe.netlify.app/docs/latest/try/getting-started-linux-macos-x/#downloading-spire-for-linux
* https://github.com/spiffe/spire-tutorials
* https://deploy-preview-272--spiffe.netlify.app/docs/latest/try/getting-started-k8s/
* https://deploy-preview-272--spiffe.netlify.app/docs/latest/keyless/vault/readme/
 
* https://spiffe.io/pdf/Solving-the-bottom-turtle-SPIFFE-SPIRE-Book.pdf
 
* https://www.zerotohero.dev/spire-rocks/
* https://johnharris.io/2020/03/aws-iam-with-spiffe-spire/
* https://medium.com/google-cloud/workload-identity-federation-for-on-premise-workloads-with-spiffe-24a861b3cf6c
* https://github.com/GoogleCloudPlatform/professional-services/tree/main/tools/spiffe-gcp-proxy
* https://medium.com/google-cloud/workload-identity-federation-for-on-premise-workloads-with-spiffe-24a861b3cf6c
